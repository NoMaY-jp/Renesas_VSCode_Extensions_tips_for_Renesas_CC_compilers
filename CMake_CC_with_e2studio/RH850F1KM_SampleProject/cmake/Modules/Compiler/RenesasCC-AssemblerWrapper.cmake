...
# Renesas CC-RX needs replacement of subcommand file because its assembler can't read a long line (over 2048 characters) correctly.
foreach(arg_n RANGE ${cmd_args_first} ${cmd_args_last})
  if(arc STREQUAL RX)
    if(CMAKE_ARGV${arg_n} MATCHES "^-subcommand=.+")
      if(NOT sub_name)
