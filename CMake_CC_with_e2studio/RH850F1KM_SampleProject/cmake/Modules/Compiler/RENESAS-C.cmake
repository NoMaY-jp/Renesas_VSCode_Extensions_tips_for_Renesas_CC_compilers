...
if(CMAKE_C_COMPILER_ARCHITECTURE_ID STREQUAL "RX")
  ...
  set(CMAKE_C99_STANDARD_COMPILE_OPTION -lang=c99 -DINTELISENSE_HELPER_C_STANDARD=99) # No strict standard option but for preventing the decay behavior.
  set(CMAKE_C99_EXTENSION_COMPILE_OPTION -lang=c99 -DINTELISENSE_HELPER_C_STANDARD=99)

  __compiler_check_default_language_standard(C 2.0 90)

elseif(CMAKE_C_COMPILER_ARCHITECTURE_ID STREQUAL "RL78")
  set(CMAKE_C90_STANDARD_COMPILE_OPTION -ansi -DINTELISENSE_HELPER_C_EXTENSIONS=0)
  set(CMAKE_C90_EXTENSION_COMPILE_OPTION "")

  if(CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 1.6)
    set(CMAKE_C99_STANDARD_COMPILE_OPTION -lang=c99 -ansi -DINTELISENSE_HELPER_C_STANDARD=99 -DINTELISENSE_HELPER_C_EXTENSIONS=0)
    set(CMAKE_C99_EXTENSION_COMPILE_OPTION -lang=c99 -DINTELISENSE_HELPER_C_STANDARD=99)
  endif()
...
elseif(CMAKE_C_COMPILER_ARCHITECTURE_ID STREQUAL "RH850")
  set(CMAKE_C90_STANDARD_COMPILE_OPTION -Xansi -DINTELISENSE_HELPER_C_EXTENSIONS=0)
  set(CMAKE_C90_EXTENSION_COMPILE_OPTION "")

  if(CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 1.7)
    set(CMAKE_C99_STANDARD_COMPILE_OPTION -lang=c99 -Xansi -DINTELISENSE_HELPER_C_STANDARD=99 -DINTELISENSE_HELPER_C_EXTENSIONS=0)
    set(CMAKE_C99_EXTENSION_COMPILE_OPTION -lang=c99 -DINTELISENSE_HELPER_C_STANDARD=99)
  endif()
